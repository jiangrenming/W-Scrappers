...
import main.demo.mobads.baidu.com.banner.R;
...
public class MZBannerView<T> extends RelativeLayout{
    ...
    private int []mIndicatorRes= new int[]{R.drawable.unseletc_dot, R.drawable.select_dot};
    ...
    private void readAttrs(Context context,AttributeSet attrs){
        ...
        Log.i("配置的数据","魅族效果bananer="+mIsOpenMZEffect+"/是否覆盖2边="+mIsMiddlePageCover);
        typedArray.recycle();
    }
    ...
    private void sureIndicatorPosition(){
        ...
        }else if (mIndicatorAlign == IndicatorAlign.BOTTOM.ordinal()){
     ...
     * @param mzHolderCreator  ViewHolder生成器
     */
    ...
    public void setIndicatorAlign(IndicatorAlign indicatorAlign) {
        ...
        if(indicatorAlign == IndicatorAlign.LEFT){
            ...
            layoutParams.addRule(RelativeLayout.CENTER_VERTICAL | RelativeLayout.ALIGN_BOTTOM);
        }else{
            layoutParams.addRule(RelativeLayout.CENTER_HORIZONTAL);
        }
        // 添加：增加设置Indicator 的上下边距。
